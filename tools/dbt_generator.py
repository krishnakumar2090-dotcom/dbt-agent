...
def generate_dbt_from_excel(file_path: str, output_dir: str = "dbt_models") -> str:
    ...
    # Extract target and base table names
    ...
    sql_path = os.path.join(output_dir, f"{target_table}.sql")
    schema_path = os.path.join(output_dir, "schema.yml")
